...
We have successfully implemented First-Person Player Movement (FPS) in the game., we have successfully build our map with tree and mountains  , and there is different different background for different different dimensions.
