...
We have successfully implemented First-Person Player Movement (FPS) in the game., we have successfully build our map with tree and mountains with smooth graphics we also add spaceship in mag from that spaceship that person come on this planet , and there is different different background for different different dimensions.
...
but there is twist you got time limit between this shift if you not shift to another dimension in an given time limit  you be dead game over , death reason is coz you got stuck inside rock you have to shift through it in given time limit you can't use shift without pressing R key then we can shift between dimensions you can't stop on one place for long time there is cooldown you have o shift between dimensions 
